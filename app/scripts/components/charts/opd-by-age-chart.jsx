...
require('stylesheets/charts/opd-by-age-chart');

const OpdByAgeChart = React.createClass({
  propTypes: {
  ...
  render() {
    ...
    return (
      <div className="ipd-by-age-chart">
        <h3 className="chart-title"><T k="chart.opd-by-age-chart.title" /> - <span className="chart-helptext"><T k="chart.opd-by-age-chart.helptext" /></span></h3>
        <div className="chart-container ">
          <TSetChildProps>
            <BarChart
                ...
                xAxis={{label: {k: `chart.opd-by-age-chart.x-axis`}}}
                yAxis={{label: {k: 'chart.opd-by-age-chart.y-axis'}}} />
              </TSetChildProps>
        </div>
      </div>
