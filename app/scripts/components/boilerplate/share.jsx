...
require('stylesheets/boilerplate/share');
            ...
            Open: () => (
              <div className="floating-div">
                <div className="share-wrapper">
                  <ul>
                    <li><Icon type={`link`}/><T k="share.share" /></li>
                    <li><Icon type={`comments-o`}/><T k="share.feedback" /></li>
                    <li><Icon type={`file-pdf-o`}/><T k="share.print" /></li>
                  </ul>
                </div>
              </div>),
